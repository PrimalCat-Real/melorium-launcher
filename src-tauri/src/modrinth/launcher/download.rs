...
use crate::modrinth::launcher::parse_rules;
...
pub async fn download_assets_index(
    ...
    loading_bar: Option<&LoadingBarId>,
    force: bool,
) -> crate::modrinth::Result<AssetsIndex> {
...
pub async fn download_libraries(
    ...
    loading_try_for_each_concurrent(
        stream::iter(libraries.iter()).map(Ok::<&Library, crate::modrinth::Error>),
        None,
        loading_bar,
        loading_amount,
        num_files,
