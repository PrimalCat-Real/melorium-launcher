...
pub fn parse_rule(
    ...
    let res = match rule {
        Rule { os: Some(os), .. } => {
            crate::modrinth::util::platform::os_rule(os, java_version, minecraft_updated)
        }
        Rule {
...
) -> crate::modrinth::Result<Option<LoaderVersion>> {
...
pub async fn install_minecraft(
    ...
    let version_index = minecraft
        ...
        .ok_or(crate::modrinth::ErrorKind::LauncherError(format!(
...
pub async fn launch_minecraft(
    ...
    // Test jre version
    let java_version =
        crate::modrinth::api::jre::check_jre(java_version.path.clone().into()).await?;
    ...
    // Load the jar resource for the java side of the launcher
