...
use crate::modrinth::launcher::quick_play_version::QuickPlayServerVersion;
use crate::modrinth::launcher::{QuickPlayVersion, parse_rules};
use crate::modrinth::profile::QuickPlayType;
use crate::modrinth::state::Credentials;
use crate::modrinth::{
    ...
    if let Some(args) = arguments {
        ...
        parsed_arguments.push(format!(
            ...
            canonicalize(natives_path)
                .map_err(|_| crate::modrinth::ErrorKind::LauncherError(format!(
...
where
    F: Fn(&str) -> crate::modrinth::Result<String>,
{
...
pub async fn get_processor_main_class(path: String) -> crate::modrinth::Result<Option<String>> {
    let main_class = tokio::task::spawn_blocking(move || {
        ...
        Ok::<Option<String>, crate::modrinth::Error>(None)
    })
    .await??;
