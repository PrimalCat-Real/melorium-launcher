...
use crate::modrinth::error::Result;
use crate::modrinth::util::protocol_version::ProtocolVersion;
...
mod modern {
    ...
    async fn ping(stream: &mut TcpStream) -> crate::modrinth::Result<i64> {
...
mod legacy {
    use super::ServerStatus;
    use crate::modrinth::worlds::{ServerPlayers, ServerVersion};
    use crate::modrinth::{Error, ErrorKind};
