use crate::modrinth::data::{Dependency, ProjectType, User, Version};
use crate::modrinth::jre::check_jre;
...
pub async fn migrate_legacy_data<'a, E>(exec: E) -> crate::modrinth::Result<()>
where
