...
use crate::modrinth::util::fetch::{FetchSemaphore, IoSemaphore};
use std::sync::Arc;
use tokio::sync::{OnceCell, Semaphore};

use crate::modrinth::state::fs_watcher::FileWatcher;
use sqlx::SqlitePool;
...
impl State {
    pub async fn init(app_identifier: String) -> crate::modrinth::Result<()> {
    ...
    pub async fn get() -> crate::modrinth::Result<Arc<Self>> {
