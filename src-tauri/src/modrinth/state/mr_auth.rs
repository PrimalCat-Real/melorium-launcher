use crate::modrinth::state::{CacheBehaviour, CachedEntry};
use crate::modrinth::util::fetch::{FetchSemaphore, fetch_advanced};
...
impl ModrinthCredentials {
    ...
    pub async fn get_all(
        exec: impl sqlx::Executor<'_, Database = sqlx::Sqlite>,
    ) -> crate::modrinth::Result<DashMap<String, Self>> {
        let res = sqlx::query!(
            "
            SELECT
                id, active, session_id, expires
    ...
    pub(crate) async fn refresh_all() -> crate::modrinth::Result<()> {
...
pub async fn finish_login_flow(
    ...
    semaphore: &FetchSemaphore,
    exec: impl sqlx::Executor<'_, Database = sqlx::Sqlite>,
) -> crate::modrinth::Result<ModrinthCredentials> {
...
async fn fetch_info(
    ...
    semaphore: &FetchSemaphore,
    exec: impl sqlx::Executor<'_, Database = sqlx::Sqlite>,
) -> crate::modrinth::Result<crate::modrinth::state::cache::User> {
