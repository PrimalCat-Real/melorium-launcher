...
use crate::modrinth::state::ProcessMetadata;
...
#[tracing::instrument]
pub async fn get_all() -> crate::modrinth::Result<Vec<ProcessMetadata>> {
...
pub async fn get_by_profile_path(
    profile_path: &str,
) -> crate::modrinth::Result<Vec<ProcessMetadata>> {
    let state = State::get().await?;
    let processes = state
        .process_manager
        .get_all()
...
#[tracing::instrument]
pub async fn kill(uuid: Uuid) -> crate::modrinth::Result<()> {
    let state = State::get().await?;
...
#[tracing::instrument]
pub async fn wait_for(uuid: Uuid) -> crate::modrinth::Result<()> {
    let state = State::get().await?;
