...
use crate::modrinth::util::fetch::{fetch_mirrors, write};
use crate::modrinth::util::io;
use crate::modrinth::{State, profile};
...
use crate::modrinth::data::ProjectType;
...
pub async fn install_zipped_mrpack_files(
    ...
    for (i, (index, file)) in override_file_entries.into_iter().enumerate() {
        ...
        let relative_override_file_path = relative_override_file_path
            ...
            .map_err(|_| {
                crate::modrinth::Error::from(crate::modrinth::ErrorKind::OtherError(
