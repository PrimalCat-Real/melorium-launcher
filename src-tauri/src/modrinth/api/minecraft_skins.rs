...
pub use crate::modrinth::state::MinecraftSkinVariant;
use crate::modrinth::{
    ErrorKind, State,
    state::{
...
#[tracing::instrument]
pub async fn get_available_capes() -> crate::modrinth::Result<Vec<Cape>> {
...
/// marked as equipped.
#[tracing::instrument]
pub async fn get_available_skins() -> crate::modrinth::Result<Vec<Skin>> {
    let state = State::get().await?;
...
/// cape equipped.
#[tracing::instrument]
pub async fn set_default_cape(cape: Option<Cape>) -> crate::modrinth::Result<()> {
    let state = State::get().await?;
...
#[tracing::instrument]
pub async fn equip_skin(skin: Skin) -> crate::modrinth::Result<()> {
    let state = State::get().await?;
...
#[tracing::instrument]
pub async fn remove_custom_skin(skin: Skin) -> crate::modrinth::Result<()> {
    let state = State::get().await?;
...
#[tracing::instrument]
pub async fn unequip_skin() -> crate::modrinth::Result<()> {
    let state = State::get().await?;
